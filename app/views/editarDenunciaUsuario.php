...
// Verifica si la denuncia pertenece al usuario actual
if ($denuncia['idUsuario'] !== $userId) {
    header("Location: misReportes.php");
    exit;
}
...
<body>
    <div class="container mt-5">
        ...
        <?php endif; ?>
        <form action="editarDenunciaUsuario.php?id=<?php echo $denunciaId; ?>" method="POST">
